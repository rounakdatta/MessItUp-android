...
public class MessMenu extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_mess_menu, container, false);
            TextView textView = (TextView) rootView.findViewById(R.id.section_label);
            textView.setText(getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER)));

//            String pageIndex = String.valueOf(getArguments().getInt(ARG_SECTION_NUMBER));
//            String toShowWeek = weekDay;
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        @Override
        public int getCount() {
            // Show 7 total pages for each day of the week.
            return 7;
        }
    }
}
